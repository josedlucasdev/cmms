...
var appGlobals = require('./app-globals-BlqrqKTN.js');
require('./ionic-global-B-cA6LkY.js');
...
var patchBrowser = () => {
  ...
  const importMeta = (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('ionic.cjs.js', document.baseURI).href));
  const opts = {};
  if (importMeta !== "") {
