...
var r = (t3) => {
  ...
  const W2 = t3, I = [], K = [], M2 = [], P3 = [], Y = [], Z = [], q2 = [], x = [], H = [], z = [], B2 = [], G = "function" == typeof AnimationEffect || void 0 !== d3 && "function" == typeof d3.AnimationEffect, J = "function" == typeof Element && "function" == typeof Element.prototype.animate && G, L2 = () => B2, N = (e, o) => {
...
var y = async (n3) => {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (await import("./p-C1aScSTo-YCHCUGOK.js")).iosTransitionAnimation : (await import("./p-DIE4pXMl-MDRBQB4W.js")).mdTransitionAnimation;
};
var h = async (n3, e) => {
  await k(e, true);
...
@ionic/core/components/p-CmR5uXej.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)

@ionic/core/components/p-CtukzcyX.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)
*/
//# sourceMappingURL=chunk-WUKXJQ3D.js.map
