import {
  ...
  createWebHistory,
  parseQuery
} from "./chunk-5RAVJY5Z.js";
import "./chunk-YFT6OQ5R.js";
import {
  shallowRef
} from "./chunk-JSFTWL3E.js";
...
var createIonRouter = (opts, router) => {
  ...
  const changeTab = (tab, path) => {
    ...
    const hrefHash = hashIndex >= 0 && hashIndex < path.length - 1 ? path.slice(hashIndex) : "";
    ...
    if (routeInfo) {
      ...
      const push = Object.assign({ query: parseQuery(effectiveSearch) }, hrefHash ? { hash: hrefHash } : {});
      if (routeInfo.pathname === pathname) {
        router.push(Object.assign({ path: routeInfo.pathname }, push));
      } else {
        router.push(Object.assign({ path: pathname }, push));
      }
    } else {
      handleNavigate(pathname + hrefSearch + hrefHash, "push", "none", void 0, tab);
    }
  };
